...
# OpenCLIP backbone weights: let open_clip auto-download from HF Hub.
HPSV2_OPENCLIP_PRETRAINED = "laion2b_s32b_b79k"
# HPSv2.1 fine-tuned weights (single .pt file).
HPSV2_REPO = "xswu/HPSv2"
HPSV2_FILENAME = "HPS_v2.1_compressed.pt"
...
class HPSv2Scorer(nn.Module):
    def __init__(self, dtype, device):
        ...
        hpsv2_ckpt_path = hf_hub_download(
            repo_id=HPSV2_REPO,
            filename=HPSV2_FILENAME,
            cache_dir=cache_dir,
        )
        checkpoint = torch.load(hpsv2_ckpt_path, map_location="cpu")
